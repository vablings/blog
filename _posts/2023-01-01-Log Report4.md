...
![[submitted_Duty 13#Pretext H&S]]

For not working in a compliant area with other machines in unergonomic ways could cause strain or other forms of injury causing absenteeism. (K10) (K11) (B5)
...
#### Overproduction
Due to the specific rejection rate of a calibrated ring being rather high overproduction is required due to the possible variability of the variability of pass rate ($\text{variablity}^2$) leading to excess stock should a batch be excellent therefore actually reducing the principle gain from said good batching 
#### Waiting 
